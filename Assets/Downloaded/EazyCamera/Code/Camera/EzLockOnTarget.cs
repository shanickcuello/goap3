...
public class EzLockOnTarget : MonoBehaviour
{
    ...
    private void Start()
    {
        if (m_playerCamera == null) m_playerCamera = FindObjectOfType<EzCamera>();
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.GetComponent<EzMotor>() != null)
        {
            ...
            {
                var lockonState = m_playerCamera.LockOnState;
                if (lockonState != null) lockonState.AddTarget(this);
            }
        }
    }
    private void OnTriggerExit(Collider other)
    {
        if (other.GetComponent<EzMotor>() != null)
        {
            ...
            var lockonState = m_playerCamera.LockOnState;
            if (lockonState != null) lockonState.RemoveTarget(this);
        }
    }
    public void SetIconActive(bool isActive = true)
    {
        if (m_targetIcon != null) m_iconRenderer.material.color = isActive ? m_activeColor : m_inactiveColor;
    }
